...
interface AuthContextType {
  ...
  signup: (name: string, email: string, password: string, level: string, semester: string, universityId?: string, facultyId?: string, departmentId?: string) => Promise<{ error: string | null }>;
  logout: () => Promise<void>;
